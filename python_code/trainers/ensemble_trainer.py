...
class EnsembleTrainer(Trainer):
    ...
    def single_eval_test(self, j, take_crc_0=False):
        ...
        output, not_satisfied_list = self.model(rx_per_snr, pass_all_words=take_crc_0, take_crc_0=take_crc_0)
    ...
    def single_eval_train(self, j, take_crc_0=False):
        ...
        output, not_satisfied_list, dec_mask = self.model(rx_per_snr, pass_all_words=take_crc_0 ,take_crc_0=take_crc_0, get_mask=True)
        decoded_words = self.decode(output)
