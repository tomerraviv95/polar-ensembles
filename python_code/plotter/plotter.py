...
config_plot_params = {'val_SNR_start' : 2,
                      'val_SNR_end' : 5,
                      'val_num_SNR' : 7,
                      'test_errors' : 500
                }
    ...
    def get_fer_plot(self, dec: Trainer, method_name: str, take_crc_0=False):
        ...
        if os.path.isfile(plots_path) and not self.run_over:
            ...
            if isinstance(dec, EnsembleTrainer):
                ber_total, fer_total = dec.evaluate_test(pass_all_words = take_crc_0,take_crc_0=take_crc_0)
            else:
...
if __name__ == '__main__':
    ...
    # plotter.plot(*get_weighted_polar_64_32_iter5_crc11_snr_2_6(), dec_type='FG')
    # # plotter.plot(*get_ensemble_64_32_iters5_crc11_uniform_decs_4(),dec_type='Ensemble')
    # plotter.plot(*get_ensemble_64_32_iters5_crc11_uniform_decs_2_best_dec_snr_2_6(), dec_type='Ensemble',
    #              take_crc_0=True)
    # plotter.plot(*get_ensemble_64_32_iters5_crc11_uniform_decs_4_best_dec_snr_2_6(), dec_type='Ensemble',
    #              take_crc_0=True)
    # plotter.plot(*get_ensemble_64_32_iters5_crc11_uniform_decs_8_best_dec_snr_2_6(), dec_type='Ensemble',
    #              take_crc_0=True)
    ...
    '''128 64'''
    plotter = Plotter(run_over=False, type='FER')
    plotter.plot(*get_polar_128_64_iter6(), dec_type='FG')
    plotter.plot(*get_weighted_polar_128_64_iter6_crc11_snr_2_5(), dec_type='FG')
    # plotter.plot(*get_ensemble_64_32_iters5_crc11_uniform_decs_4(),dec_type='Ensemble')
    plotter.plot(*get_ensemble_128_64_iters6_crc11_uniform_decs_2_best_dec_snr_2_5(), dec_type='Ensemble',
                 take_crc_0=True)
    plotter.plot(*get_ensemble_128_64_iters6_crc11_uniform_decs_4_best_dec_snr_2_5(), dec_type='Ensemble',
                 take_crc_0=True)
    plotter.plot(*get_ensemble_128_64_iters6_crc11_uniform_decs_8_best_dec_snr_2_5(), dec_type='Ensemble',
                 take_crc_0=True)
    # plotter = Plotter(run_over=True, type='FER')
