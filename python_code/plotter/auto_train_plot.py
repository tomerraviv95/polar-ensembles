...
def get_weighted_polar_1024_512_crc11():
    graph_params = {'color': 'green', 'marker': 'o'}
    runs_params = {'code_type': 'Polar', 'code_len': 1024, 'info_len': 512, 'load_weights': True , 'iteration_num':6, 'crc_order': 11, 'train_minibatch_size': 200}
    script_params = {"decoder_type":"WFG"}
    return graph_params, runs_params, script_params

def get_ensemble_polar_512_256_crc11_iter6_decs_2():
    graph_params = {'color': 'blue', 'marker': 'x'}
    runs_params = {'code_type': 'Polar', 'code_len': 512, 'info_len': 256, 'load_weights': True , 'iteration_num':6, 'crc_order': 11, 'train_minibatch_size': 1000, 'ensemble_dec_num': 2,'ensemble_crc_dist':'sum'}
    script_params = {"decoder_type":"Ensemble"}
    return graph_params, runs_params, script_params

def get_ensemble_polar_512_256_crc11_iter6_decs_8():
    graph_params = {'color': 'blue', 'marker': 'x'}
    runs_params = {'code_type': 'Polar', 'code_len': 512, 'info_len': 256, 'load_weights': True , 'iteration_num':6, 'crc_order': 11, 'train_minibatch_size': 1000, 'ensemble_dec_num': 8,'ensemble_crc_dist':'sum'}
    script_params = {"decoder_type":"Ensemble"}
    return graph_params, runs_params, script_params

def get_ensemble_polar_1024_512_crc11_iter6_decs_4():
    graph_params = {'color': 'blue', 'marker': 'x'}
    runs_params = {'code_type': 'Polar', 'code_len': 1024, 'info_len': 512, 'load_weights': True , 'iteration_num':6, 'crc_order': 11, 'train_minibatch_size': 1000, 'ensemble_dec_num': 4,'ensemble_crc_dist':'sum'}
    script_params = {"decoder_type":"Ensemble"}
    return graph_params, runs_params, script_params

def get_ensemble_polar_1024_512_crc11_iter6_decs_8():
    graph_params = {'color': 'blue', 'marker': 'x'}
    runs_params = {'code_type': 'Polar', 'code_len': 1024, 'info_len': 512, 'load_weights': True , 'iteration_num':6, 'crc_order': 11, 'train_minibatch_size': 1000, 'ensemble_dec_num': 8,'ensemble_crc_dist':'sum'}
    script_params = {"decoder_type":"Ensemble"}
    return graph_params, runs_params, script_params
...
def TrainDecs(decs_to_train):
    ...
    for dec in decs_to_train:
        ...
        # if 'run_name' not in runs_params: #implemented inside the decoders trainers
        ...
        print(f"############ run named: {CONFIG.run_name} took {round(script_params['train_time'])} sec to train ############")
...
if __name__ == '__main__':
    ...
    '''
    decs_to_train_and_plot = [get_weighted_polar_512_256_crc11, get_weighted_polar_1024_512_crc11, get_ensemble_polar_512_256_crc11_iter6_decs_2, get_ensemble_polar_512_256_crc11_iter6_decs_8, get_ensemble_polar_1024_512_crc11_iter6_decs_4, get_ensemble_polar_1024_512_crc11_iter6_decs_8]
    decs_to_plot_only = []
    decs_to_load_plot = []
